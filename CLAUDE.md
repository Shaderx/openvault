...
- **State Locks**: `operationState.extractionInProgress` (`src/state.js`) is for MANUAL backfill and Emergency Cut. Background worker uses `isRunning` (`worker.js`). They mutually exclude.
