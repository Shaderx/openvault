...
CRITICAL: NEVER include memory IDs (like event_123 or ref_123) in the "insight" or "question" text. IDs belong ONLY in the evidence_ids array.`;
...
CRITICAL: NEVER include memory IDs (like event_123 or ref_123) in the "insight" text. IDs belong ONLY in the evidence_ids array.`;
