...
describe('Reflection level derivation from parent_ids', () => {
    it('derives level=3 when synthesizing level-2 parent reflections', async () => {
        ...
        const memoriesWithReflections = [
            {
                id: 'ev_100', type: 'event', summary: 'Some event', importance: 3,
                sequence: 100, message_ids: [10], characters_involved: ['Alice'], witnesses: ['Alice'],
                embedding: [0.5, -0.5, 0.5], // Low cosine similarity with reflections (different dim count avoids accidental high sim)
            },
            {
                id: 'ev_101', type: 'event', summary: 'Another event', importance: 4,
                sequence: 200, message_ids: [20], characters_involved: ['Alice'], witnesses: ['Alice'],
                embedding: [-0.5, 0.5, 0.5],
            },
            {
                id: 'ev_102', type: 'event', summary: 'Third event', importance: 5,
                sequence: 300, message_ids: [30], characters_involved: ['Alice'], witnesses: ['Alice'],
                embedding: [0.5, 0.5, -0.5],
            },
            {
                id: 'ev_103', type: 'event', summary: 'Fourth event', importance: 4,
                sequence: 400, message_ids: [40], characters_involved: ['Alice'], witnesses: ['Alice'],
                embedding: [-0.5, -0.5, 0.5],
            },
            {
                id: 'ref_old_1', type: 'reflection', summary: 'Level 1 insight', level: 1,
                sequence: 50, character: 'Alice', characters_involved: ['Alice'], witnesses: ['Alice'],
                parent_ids: [], source_ids: ['ev_100'], importance: 4, archived: false,
                embedding: [0.0, 1.0], // Far from [0.5, 0.5] to avoid pre-flight similarity gate
            },
            {
                id: 'ref_old_2', type: 'reflection', summary: 'Level 2 meta-insight', level: 2,
                sequence: 60, character: 'Alice', characters_involved: ['Alice'], witnesses: ['Alice'],
                parent_ids: ['ref_old_1'], source_ids: [], importance: 4, archived: false,
    ...
    it('caps level at maxReflectionLevel', async () => {
        ...
        const memoriesWithMaxLevel = [
            {
                id: 'ev_200', type: 'event', summary: 'Event A', importance: 5,
                sequence: 1000, message_ids: [100], characters_involved: ['Alice'], witnesses: ['Alice'],
                embedding: [0.5, -0.5, 0.5],
            },
            {
                id: 'ev_201', type: 'event', summary: 'Event B', importance: 5,
                sequence: 1001, message_ids: [101], characters_involved: ['Alice'], witnesses: ['Alice'],
                embedding: [-0.5, 0.5, 0.5],
            },
            {
                id: 'ev_202', type: 'event', summary: 'Event C', importance: 5,
                sequence: 1002, message_ids: [102], characters_involved: ['Alice'], witnesses: ['Alice'],
                embedding: [0.5, 0.5, -0.5],
            },
            {
                id: `ref_max`, type: 'reflection', summary: 'Max level insight', level: maxLevel,
                sequence: 500, character: 'Alice', characters_involved: ['Alice'], witnesses: ['Alice'],
                parent_ids: [], source_ids: ['ev_200'], importance: 4, archived: false,
                embedding: [0.0, 1.0], // Far from [0.5, 0.5] to avoid pre-flight similarity gate
            },
        ];
